...
all: $(BUILD_DIR)/main.o $(BUILD_DIR)/domain.o $(BUILD_DIR)/potential.o $(BUILD_DIR)/initial_conditions.o $(BUILD_DIR)/time_evolution.o
	$(CC) $(OPTFLAG) $(OMPFLAG) $(INC_FLAGS) -o domain $(BUILD_DIR)/main.o $(BUILD_DIR)/domain.o $(BUILD_DIR)/potential.o $(BUILD_DIR)/initial_conditions.o $(BUILD_DIR)/time_evolution.o
...
$(BUILD_DIR)/potential.o: $(SRC_DIR)/potential.cpp
	$(CC) $(OPTFLAG) $(OMPFLAG) $(INC_FLAGS) -c $(SRC_DIR)/potential.cpp -o $(BUILD_DIR)/potential.o
